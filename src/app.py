...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Add 2 more sports related activities
    ...
    # Add 2 more artistic activities
    activities["Art Club"] = {
    ...
    # Add 2 more intellectual activities
    activities["Debate Club"] = {
        "description": "Learn debate skills and participate in competitions",
